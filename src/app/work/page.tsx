                    ...
                    <div className="grid gap-6">
                      <div className="grid gap-3">
                        ...
                        <Input
                          ...
                          type="text"
                          className="w-full"
                          defaultValue="Bridge construction at Dommeru"
                        />
                      </div>
                      <div className="grid gap-3">
                      ...
                      <div className="grid gap-3">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="atLaboratory">In Laboratory</SelectItem>
                            <SelectItem value="inFliedWork">In Field work</SelectItem>
                            <SelectItem value="paymentPending">Payment pending</SelectItem>
                            <SelectItem value="quoation">Preparing Quotation</SelectItem>
            ...
            Upload File
                ...
                >
                  <CardHeader>
                    ...
                    <CardDescription>
                      Images taken during field work
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
